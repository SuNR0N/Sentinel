...
window.calendar_languages['hu-HU'] = {
	error_noview: 'Naptár: Nézet {0} nem talalható',
	error_dateformat: 'Naptár: Hibás dátum formátum {0}. Az alábbi formátumok használhatóak: "now" vagy "yyyy-mm-dd"',
	error_loadurl: 'Naptár: Esemény URL nincs beállítva',
	error_where: 'Naptár: Hibás navigációs irány {0}. Csak az alábbi értékek érvényesek: "next" vagy "prev" vagy "today"',
	error_timedevide: 'Naptár: Az időegység paraméternek 60 osztójának kell lennie. Mint például 10, 15, 30',

	no_events_in_day: 'Nincs esemeny bejegyezve erre a napra.',
	...
	time:        'Idő',
	events:      'Események',
	before_time: 'Az idővonal vége előtt fejeződik be',
	...
	holidays: {
        '01-01':     'Ujev',
        '15-03':     'Az 1848-as forradalom unnepe',
        'easter+1':  'Hustvet Hetfo',
        '01-05':     'Majus Elseje',
        'easter+50': 'Punkosd Hetfo',
        '20-08':     'Az allamalapitas unnepe',
        '23-10':     'Az 1956-os forradalom unnepe',
        '25-12':     'Karacsony',
        '26-12':     'Karacsony'
	}
};